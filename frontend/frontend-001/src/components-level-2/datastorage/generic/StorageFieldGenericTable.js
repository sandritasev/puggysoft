...
import tableModel from "../../../models/datastorage/fieldTableModels";

function StorageFieldGenericTable (props) {
  const {
    numberPagesToShow,
    tableTitle,
    tableSubTitle,
  ...
  const { value: criteriaType, onChange: criteriaOnChangeType, setValue: criteriaSetType } = useInput("");
  ...
  const { value: operatorType, onChange: operatorOnChangeType, setValue: operatorSetType } = useInput(enumCompareOperators.TEXT_CONTAINS);
  ...
  const { arrayColumnsFilter, clearFilters, getFilterBody, arrayColumnsLabels, arrayDataFields } = tableModel(
    ...
    /* TYPE */criteriaType, criteriaOnChangeType, criteriaSetType, operatorType, operatorOnChangeType, operatorSetType,
...
export default StorageFieldGenericTable;

StorageFieldGenericTable.propTypes = {
...
StorageFieldGenericTable.defaultProps = {
  numberPagesToShow: 0,
  tableTitle: "",
