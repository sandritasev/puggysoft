...
import roleTableModels from "../../../models/users/roleTableModels";

function RoleGenericTable (props) {
  const {
    numberPagesToShow,
    tableTitle,
    tableSubTitle,
  ...
  const { arrayColumnsFilter, clearFilters, getFilterBody, arrayColumnsLabels, arrayDataFields } = roleTableModels(
    columnsToShow,
...
export default RoleGenericTable;

RoleGenericTable.propTypes = {
