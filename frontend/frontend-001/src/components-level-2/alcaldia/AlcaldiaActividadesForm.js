...
} from "../../validations/alcaldia/HandleAlcaldiaActividadesFormValidations";
import CommonMessage from "../../components-level-1/CommonMessage";

import "./../css/all-forms.css";

function AlcaldiaActividadesForm () {
  ...
  const name =
    isEdit && isEdit.data.name !== null ? isEdit.data.name : "";
  ...
  return (
    <div className="puggysoft-form-thirty-with">
      ...
      <Card>
        <Card.Header as="h3">
          {i18n.alcaldiaActividadesForm.title}
        </Card.Header>
        <Card.Body>
          <Form>
            <Form.Group className="mb-3" controlId="name">
              <Form.Label>
                {i18n.alcaldiaActividadesForm.fieldName}
              </Form.Label>
              <Form.Control
                onChange={onChangeName}
                value={valueName}
                type="text"
                placeholder={i18n.alcaldiaActividadesForm.fieldName}
              />
              <Form.Text muted className={classNameFormText.name}>
                {i18n.alcaldiaActividadesForm.fieldNameText}
              </Form.Text>
            </Form.Group>
...
export default AlcaldiaActividadesForm;
