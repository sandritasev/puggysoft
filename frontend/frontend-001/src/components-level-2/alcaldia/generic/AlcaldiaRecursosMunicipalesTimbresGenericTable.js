...
import alcaldiaRecursosMunicipalesTimbresTableModels from "../../../models/alcaldia/alcaldiaRecursosMunicipalesTimbresTableModels";

function AlcaldiaRecursosMunicipalesTimbresGenericTable (props) {
  const {
    numberPagesToShow,
    tableTitle,
    tableSubTitle,
  ...
  const { arrayColumnsFilter, clearFilters, getFilterBody, arrayColumnsLabels, arrayDataFields } = alcaldiaRecursosMunicipalesTimbresTableModels(
    columnsToShow,
...
export default AlcaldiaRecursosMunicipalesTimbresGenericTable;

AlcaldiaRecursosMunicipalesTimbresGenericTable.propTypes = {
...
AlcaldiaRecursosMunicipalesTimbresGenericTable.defaultProps = {
  numberPagesToShow: 0,
  tableTitle: "",
