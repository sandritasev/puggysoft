...
function AlcaldiaRecursosMunicipalesTimbresVentasGenericTable (props) {
  ...
  // const { value: criteriaCantidad, onChange: criteriaOnChangeCantidad, setValue: criteriaSetCantidad } = useInput("");
  ...
  // const { value: operatorCantidad, onChange: operatorOnChangeCantidad, setValue: operatorSetCantidad } = useInput(enumCompareOperators.TEXT_CONTAINS);
  ...
  const { arrayColumnsFilter, clearFilters, getFilterBody, arrayColumnsLabels, arrayDataFields } = alcaldiaRecursosMunicipalesTimbresVentasTableModels(
    ...
    // /* CANTIDAD */criteriaCantidad, criteriaOnChangeCantidad, criteriaSetCantidad, operatorCantidad, operatorOnChangeCantidad, operatorSetCantidad,
