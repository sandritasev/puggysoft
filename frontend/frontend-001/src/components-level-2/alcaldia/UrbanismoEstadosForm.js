...
} from "../../validations/alcaldia/HandleUrbanismoEstadosFormValidations";
import CommonMessage from "../../components-level-1/CommonMessage";

import "./../css/all-forms.css";

function UrbanismoEstadosForm () {
  ...
  return (
    <div className="puggysoft-form-thirty-with">
      ...
      <Card>
        <Card.Header as="h3">
          {i18n.urbanismoEstadosForm.title}
        </Card.Header>
        <Card.Body>
          <Form>
            <Form.Group className="mb-3" controlId="nombre">
              <Form.Label>
                {i18n.urbanismoEstadosForm.fieldNombre}
              </Form.Label>
              <Form.Control
                onChange={onChangeNombre}
                value={valueNombre}
                type="text"
                placeholder={i18n.urbanismoEstadosForm.fieldNombre}
              />
              <Form.Text muted className={classNameFormText.nombre}>
                {i18n.urbanismoEstadosForm.fieldNombreText}
              </Form.Text>
            </Form.Group>
            <Form.Group className="mb-3" controlId="nombreCorto">
              <Form.Label>
                {i18n.urbanismoEstadosForm.fieldNombreCorto}
              </Form.Label>
              <Form.Control
                onChange={onChangeNombreCorto}
                value={valueNombreCorto}
                type="text"
                placeholder={i18n.urbanismoEstadosForm.fieldNombreCorto}
                disabled={!!isEdit}
              />
              <Form.Text muted className={classNameFormText.nombreCorto}>
                {i18n.urbanismoEstadosForm.fieldNombreCortoText}
              </Form.Text>
            </Form.Group>
...
export default UrbanismoEstadosForm;
