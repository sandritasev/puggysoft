...
function SalesTableFilterInProgress () {
  const tableTitle = i18n.saleTable.titleInProgressSales;
  ...
  function handleDetails (saleData) {
    history.push({
      ...
      state: {
        data: { saleData, saleTableViewType: enumSaleTableViewType.FOR_DISPATCHER }
      }
    });
  }
  ...
  return (
    <SalesTableFilterGeneric
      ...
      tableFilterSaleStatusCriteria={enumSaleStatus.IN_PROGRESS}
...
export default SalesTableFilterInProgress;
