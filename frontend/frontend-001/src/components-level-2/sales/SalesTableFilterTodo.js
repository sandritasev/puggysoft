...
function SalesTableFilterTodo () {
  const tableTitle = i18n.saleTable.titleTodoSales;
  ...
  function handleDetails (saleData) {
    history.push({
      ...
      state: {
        data: { saleData, saleTableViewType: enumSaleTableViewType.FOR_CASHIER }
      }
    });
  }
  ...
  return (
    <SalesTableFilterGeneric
      ...
      tableFilterSaleStatusCriteria={ enumSaleStatus.TODO}
...
export default SalesTableFilterTodo;
