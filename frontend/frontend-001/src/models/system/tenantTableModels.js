...
const resourcesTableModels = function (
  ...
  if (isMedium) {
    ...
    arrayColumnsFilter.splice(arrayColumnsFilter.length - 6, 6);
    arrayColumnsLabels.splice(arrayColumnsLabels.length - 6, 6);
    arrayDataFields.splice(arrayDataFields.length - 6, 6);
    arrayColumnsFilter.splice(0, 2);
    arrayColumnsLabels.splice(0, 2);
    arrayDataFields.splice(0, 2);
  }
