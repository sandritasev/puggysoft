...
import arrayFields from "./fieldTableFields";
import arrayLabels from "./fieldTableLabels";
import schemaTableFilter from "./fieldTableFilter";
...
const schemaTableModels = function (
  ...
  const setOperatorsDefaultValues = function () {
    ...
    operatorSetType(enumCompareOperators.TEXT_EQUALS);
  ...
  const getFilterBody = () => {
    ...
    const filterBody = {
      ...
      typeCriteria: criteriaType,
      typeOperator: operatorType,
      textboxOptionCriteria: "",
      textboxOptionOperator: enumFilterType.NONE,
