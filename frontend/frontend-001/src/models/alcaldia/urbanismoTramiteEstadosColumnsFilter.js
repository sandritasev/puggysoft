...
const urbanismoTramiteEstadosColumnsFilter = function (
  /* ID */ criteriaId,
  criteriaOnChangeId,
  operatorId,
  operatorOnChangeId,
  ...
  const arrayColumnsFilter = [
    ...
    {
      type: enumFilterType.NUMBER,
      criteriaValue: criteriaCi,
      criteriaOnchange: criteriaOnChangeCi,
      operatorValue: operatorCi,
      operatorOnchange: operatorOnChangeCi
    },
    {
      type: enumFilterType.TEXTBOX,
...
export default urbanismoTramiteEstadosColumnsFilter;
