...
import arrayDataFieldsImport from "./urbanismoRequisitosDataFields";
import arrayColumnsLabelsImport from "./urbanismoRequisitosColumnsLabels";
import urbanismoRequisitosColumnsFilter from "./urbanismoRequisitosColumnsFilter";

const urbanismoRequisitosTableModels = function (
  tableColumnsToShow,
  ...
  let arrayColumnsFilter = urbanismoRequisitosColumnsFilter(
...
export default urbanismoRequisitosTableModels;
