 ...
 */
@Data
public class DtoStorageFieldFilter {
  ...
  public EnumCompareOperator typeOperator;
  // textboxOption
  public String textboxOptionCriteria;
  public EnumCompareOperator textboxOptionOperator;
  // TENANT
