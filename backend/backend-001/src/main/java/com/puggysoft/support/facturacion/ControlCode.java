...
public class ControlCode {
   ...
   * @param authNumber Numero de autorizacion.
   * @param invNumber Numero de factura.
   * @param nitci NIT o CI.
   * @param dateTransaction fecha de transaccion de la forma: 2007/07/02 a 20070702.
   * @param tranAmount Monto de la transacción.
   * @param dosKey Llave de dosificacion.
   * @return String Codigo de control.
   */
  public String generate(String authNumber, String invNumber, String nitci, String dateTransaction, String tranAmount, String dosKey) {
    this.authorizationNumber = authNumber;
    this.invoiceNumber = invNumber;
    this.nitCiCliente = nitci;
    this.dateOfTransaction = dateTransaction;
    this.transactionAmount = roundUp(tranAmount);
    this.dosageKey = dosKey;

    /* ========== PASO 1 ============= */
    invoiceNumber = addVerhoeffDigit(invoiceNumber,2);
    nitCiCliente = addVerhoeffDigit(nitCiCliente,2);
    ...
    String nitCidKey = nitCiCliente + string3;
