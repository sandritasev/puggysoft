...
@Service
public class ServiceAlcaldiaRecursosMunicipalesVentaDetalleDeleteById {
  ...
  public ResponseEntity<String> deleteById(Long id) {
    try {
      if (repositoryAlcaldiaRecursosMunicipalesVentaDetalle.existsById(id)) {
        repositoryAlcaldiaRecursosMunicipalesVentaDetalle.deleteById(id);
